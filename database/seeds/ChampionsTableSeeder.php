...
class ChampionsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Champion::create(['name' => 'Camille', 'description' => "", 'cost_id' => 1, 'tier_id' => 6, 'image' => 'Camille.png', 'enabled' => true]);
        Champion::create(['name' => 'Darius', 'description' => "", 'cost_id' => 1, 'tier_id' => 4, 'image' => 'Darius.png', 'enabled' => true]);
        Champion::create(['name' => 'Elise', 'description' => "", 'cost_id' => 1, 'tier_id' => 6, 'image' => 'Elise.png', 'enabled' => true]);
        ...
        Champion::create(['name' => 'Graves', 'description' => "", 'cost_id' => 1, 'tier_id' => 4, 'image' => 'Graves.png', 'enabled' => true]);
        Champion::create(['name' => 'Kassadin', 'description' => "", 'cost_id' => 1, 'tier_id' => 3, 'image' => 'Kassadin.png', 'enabled' => true]);
        Champion::create(['name' => 'Khazix', 'description' => "", 'cost_id' => 1, 'tier_id' => 4, 'image' => 'Khazix.png', 'enabled' => true]);
        Champion::create(['name' => 'Mordekaiser', 'description' => "", 'cost_id' => 1, 'tier_id' => 6, 'image' => 'Mordekaiser.png', 'enabled' => true]);
        ...
        Champion::create(['name' => 'Blitzcrank', 'description' => "", 'cost_id' => 2, 'tier_id' => 3, 'image' => 'Blitzcrank.png', 'enabled' => true]);
        ...
        Champion::create(['name' => "Rek'Sai", 'description' => "", 'cost_id' => 2, 'tier_id' => 4, 'image' => 'RekSai.png', 'enabled' => true]);
        Champion::create(['name' => 'Shen', 'description' => "", 'cost_id' => 2, 'tier_id' => 4, 'image' => 'Shen.png', 'enabled' => true]);
        Champion::create(['name' => 'Twisted Fate', 'description' => "", 'cost_id' => 2, 'tier_id' => 4, 'image' => 'TwistedFate.png', 'enabled' => true]);
        ...
        Champion::create(['name' => 'Ashe', 'description' => "", 'cost_id' => 3, 'tier_id' => 2, 'image' => 'Ashe.png', 'enabled' => true]);
        Champion::create(['name' => 'Evelynn', 'description' => "", 'cost_id' => 3, 'tier_id' => 2, 'image' => 'Evelynn.png', 'enabled' => true]);
        Champion::create(['name' => 'Gangplank', 'description' => "", 'cost_id' => 3, 'tier_id' => 4, 'image' => 'Gangplank.png', 'enabled' => true]);
        Champion::create(['name' => 'Katarina', 'description' => "", 'cost_id' => 3, 'tier_id' => 2, 'image' => 'Katarina.png', 'enabled' => true]);
        Champion::create(['name' => 'Kennen', 'description' => "", 'cost_id' => 3, 'tier_id' => 2, 'image' => 'Kennen.png', 'enabled' => true]);
        Champion::create(['name' => 'Morgana', 'description' => "", 'cost_id' => 3, 'tier_id' => 3, 'image' => 'Morgana.png', 'enabled' => true]);
        Champion::create(['name' => 'Poppy', 'description' => "", 'cost_id' => 3, 'tier_id' => 2, 'image' => 'Poppy.png', 'enabled' => true]);
        Champion::create(['name' => 'Rengar', 'description' => "", 'cost_id' => 3, 'tier_id' => 3, 'image' => 'Rengar.png', 'enabled' => true]);
        Champion::create(['name' => 'Shyvana', 'description' => "", 'cost_id' => 3, 'tier_id' => 1, 'image' => 'Shyvana.png', 'enabled' => true]);
        Champion::create(['name' => 'Veigar', 'description' => "", 'cost_id' => 3, 'tier_id' => 4, 'image' => 'Veigar.png', 'enabled' => true]);
        Champion::create(['name' => 'Vi', 'description' => "", 'cost_id' => 3, 'tier_id' => 3, 'image' => 'Vi.png', 'enabled' => true]);
        ...
        Champion::create(['name' => 'Draven', 'description' => "", 'cost_id' => 4, 'tier_id' => 2, 'image' => 'Draven.png', 'enabled' => true]);
        Champion::create(['name' => 'Gnar', 'description' => "", 'cost_id' => 4, 'tier_id' => 1, 'image' => 'Gnar.png', 'enabled' => true]);
        Champion::create(['name' => 'Jinx', 'description' => "", 'cost_id' => 4, 'tier_id' => 4, 'image' => 'Jinx.png', 'enabled' => true]);
        Champion::create(['name' => 'Kindred', 'description' => "", 'cost_id' => 4, 'tier_id' => 2, 'image' => 'Kindred.png', 'enabled' => true]);
        Champion::create(['name' => 'Leona', 'description' => "", 'cost_id' => 4, 'tier_id' => 3, 'image' => 'Leona.png', 'enabled' => true]);
        Champion::create(['name' => 'Sejuani', 'description' => "", 'cost_id' => 4, 'tier_id' => 2, 'image' => 'Sejuani.png', 'enabled' => true]);

        // Fill champions cost 5.
        Champion::create(['name' => 'Anivia', 'description' => "", 'cost_id' => 5, 'tier_id' => 3, 'image' => 'Anivia.png', 'enabled' => true]);
        Champion::create(['name' => 'Karthus', 'description' => "", 'cost_id' => 5, 'tier_id' => 2, 'image' => 'Karthus.png', 'enabled' => true]);
        Champion::create(['name' => 'Kayle', 'description' => "", 'cost_id' => 5, 'tier_id' => 2, 'image' => 'Kayle.png', 'enabled' => true]);
        Champion::create(['name' => 'Miss Fortune', 'description' => "", 'cost_id' => 5, 'tier_id' => 4, 'image' => 'MissFortune.png', 'enabled' => true]);
        Champion::create(['name' => 'Pantheon', 'description' => "", 'cost_id' => 5, 'tier_id' => 2, 'image' => 'Pantheon.png', 'enabled' => true]);
        Champion::create(['name' => 'Swain', 'description' => "", 'cost_id' => 5, 'tier_id' => 1, 'image' => 'Swain.png', 'enabled' => true]);
        Champion::create(['name' => 'Yasuo', 'description' => "", 'cost_id' => 5, 'tier_id' => 1, 'image' => 'Yasuo.png', 'enabled' => true]);
        Champion::create(['name' => "Kai'sa", 'description' => "", 'cost_id' => 5, 'tier_id' => 1, 'image' => "kaisa.png", 'enabled' => true]);
    }
}
