...
class ChampionsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Champion::create(['id' => 4, 'name' => 'Fiora', 'description' => "", 'cost_id' => 1, 'tier_id' => 4, 'image' => 'Fiora.png', 'enabled' => true]);
        Champion::create(['id' => 5, 'name' => 'Garen', 'description' => "", 'cost_id' => 1, 'tier_id' => 4, 'image' => 'Garen.png', 'enabled' => true]);
        Champion::create(['id' => 6, 'name' => 'Graves', 'description' => "", 'cost_id' => 1, 'tier_id' => 4, 'image' => 'Graves.png', 'enabled' => true]);
        Champion::create(['id' => 7, 'name' => 'Kassadin', 'description' => "", 'cost_id' => 1, 'tier_id' => 3, 'image' => 'Kassadin.png', 'enabled' => true]);
        Champion::create(['id' => 8, 'name' => 'Khazix', 'description' => "", 'cost_id' => 1, 'tier_id' => 4, 'image' => 'Khazix.png', 'enabled' => true]);
        Champion::create(['id' => 9, 'name' => 'Mordekaiser', 'description' => "", 'cost_id' => 1, 'tier_id' => 6, 'image' => 'Mordekaiser.png', 'enabled' => true]);
        ...
        Champion::create(['id' => 15, 'name' => 'Blitzcrank', 'description' => "", 'cost_id' => 2, 'tier_id' => 3, 'image' => 'Blitzcrank.png', 'enabled' => true]);
        Champion::create(['id' => 16, 'name' => 'Braum', 'description' => "", 'cost_id' => 2, 'tier_id' => 4, 'image' => 'Braum.png', 'enabled' => true]);
        Champion::create(['id' => 17, 'name' => 'Jayce', 'description' => "", 'cost_id' => 2, 'tier_id' => 5, 'image' => 'Jayce.png', 'enabled' => true]);
        ...
        Champion::create(['id' => 21, 'name' => 'Pyke', 'description' => "", 'cost_id' => 2, 'tier_id' => 4, 'image' => 'Pyke.png', 'enabled' => true]);
        ...
        Champion::create(['id' => 26, 'name' => 'Zed', 'description' => "", 'cost_id' => 2, 'tier_id' => 3, 'image' => 'Zed.png', 'enabled' => true]);

        // Fill champions cost 3.
        Champion::create(['id' => 27, 'name' => 'Aatrox', 'description' => "", 'cost_id' => 3, 'tier_id' => 3, 'image' => 'Aatrox.png', 'enabled' => true]);
        Champion::create(['id' => 28, 'name' => 'Ashe', 'description' => "", 'cost_id' => 3, 'tier_id' => 2, 'image' => 'Ashe.png', 'enabled' => true]);
        Champion::create(['id' => 29, 'name' => 'Evelynn', 'description' => "", 'cost_id' => 3, 'tier_id' => 2, 'image' => 'Evelynn.png', 'enabled' => true]);
        ...
        Champion::create(['id' => 32, 'name' => 'Kennen', 'description' => "", 'cost_id' => 3, 'tier_id' => 2, 'image' => 'Kennen.png', 'enabled' => true]);
        Champion::create(['id' => 33, 'name' => 'Morgana', 'description' => "", 'cost_id' => 3, 'tier_id' => 3, 'image' => 'Morgana.png', 'enabled' => true]);
        Champion::create(['id' => 34, 'name' => 'Poppy', 'description' => "", 'cost_id' => 3, 'tier_id' => 2, 'image' => 'Poppy.png', 'enabled' => true]);
        Champion::create(['id' => 35, 'name' => 'Rengar', 'description' => "", 'cost_id' => 3, 'tier_id' => 3, 'image' => 'Rengar.png', 'enabled' => true]);
        ...
        Champion::create(['id' => 39, 'name' => 'Volibear', 'description' => "", 'cost_id' => 3, 'tier_id' => 3, 'image' => 'Volibear.png', 'enabled' => true]);

        // Fill champions cost 4.
        Champion::create(['id' => 40, 'name' => 'Akali', 'description' => "", 'cost_id' => 4, 'tier_id' => 2, 'image' => 'Akali.png', 'enabled' => true]);
        ...
        Champion::create(['id' => 44, 'name' => 'Draven', 'description' => "", 'cost_id' => 4, 'tier_id' => 2, 'image' => 'Draven.png', 'enabled' => true]);
        Champion::create(['id' => 45, 'name' => 'Gnar', 'description' => "", 'cost_id' => 4, 'tier_id' => 1, 'image' => 'Gnar.png', 'enabled' => true]);
        Champion::create(['id' => 46, 'name' => 'Jinx', 'description' => "", 'cost_id' => 4, 'tier_id' => 4, 'image' => 'Jinx.png', 'enabled' => true]);
        ...
        Champion::create(['id' => 49, 'name' => 'Sejuani', 'description' => "", 'cost_id' => 4, 'tier_id' => 2, 'image' => 'Sejuani.png', 'enabled' => true]);
        ...
        Champion::create(['id' => 53, 'name' => 'Miss Fortune', 'description' => "", 'cost_id' => 5, 'tier_id' => 4, 'image' => 'MissFortune.png', 'enabled' => true]);
        ...
        Champion::create(['id' => 57, 'name' => "Kai'sa", 'description' => "", 'cost_id' => 5, 'tier_id' => 1, 'image' => "kaisa.png", 'enabled' => true]);
    }
}
