...
class ItemsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Item::create(['name' => "Gant d'entraînement", 'description' => "+ 10 % esquive <br /> + 10 % de chances de coup critique", 'tier_id' => NULL, 'item1_id' => NULL, 'item2_id' => NULL, 'image' => 'SparringGloves.png', 'enabled' => false]); // 9.
        ...
        Item::create(['name' => "Lame d'infini", 'description' => "Les dégâts des coups critiques sont augmentés de 100 %", 'tier_id' => 2, 'item1_id' => 1, 'item2_id' => 1, 'image' => 'InfinityEdge.png', 'enabled' => true]);
        // 9.19 Item::create(['name' => "Lame du seigneur", 'description' => "Le champion ne peut pas porter d'autres objets, à l'exception de ceux obtenus grâce à cet objet. Il est impossible de donner cet objet à un champion qui possède déjà un objet. À chaque élimination, vous gagnez un BF Glaive.", 'tier_id' => 4, 'item1_id' => 1, 'item2_id' => 6, 'image' => 'LordsEdge.png', 'enabled' => true]);
        ...
        Item::create(['name' => "Rédemption", 'description' => "A la mort, soigne les alliés proches de 1000 PV", 'tier_id' => 1, 'item1_id' => 3, 'item2_id' => 4, 'image' => 'Redemption.png', 'enabled' => true]);
        ...
        Item::create(['name' => "Épée du Divin", 'description' => "5% de chance chaque seconde d'avoir 100% de critique", 'tier_id' => 4, 'item1_id' => 1, 'item2_id' => 6, 'image' => 'SwordoftheDivine.png', 'enabled' => true]);
        // 9.19 Item::create(['name' => "Dernier souffle", 'description' => "inflige des dégâts bruts équivalents à 5 % des PV max de la cible", 'tier_id' => 4, 'item1_id' => 1, 'item2_id' => 6, 'image' => 'LastWhisper.png', 'enabled' => true]);
        ...
        Item::create(['name' => "Hydre titanesque", 'description' => "Les attaques infligent 10% des PV max de dégâts éparpillés", 'tier_id' => 5, 'item1_id' => 4, 'item2_id' => 6, 'image' => 'TitanicHydra.png', 'enabled' => true]);
        ...
        Item::create(['name' => "Griffe du Dragon", 'description' => "83% de résistance magique", 'tier_id' => 2, 'item1_id' => 2, 'item2_id' => 2, 'image' => 'DragonsClaw.png', 'enabled' => true]);
        ...
        // 9.19 Item::create(['name' => "Gants de voleur", 'description' => "Au début de la manche, vous gagnez deux objets temporaires", 'tier_id' => NULL, 'item1_id' => 9, 'item2_id' => 6, 'image' => 'HandOfJustice.png', 'enabled' => true]);
        // 9.19 Item::create(['name' => "Main de la justice", 'description' => "Le porteur gagne de manière aléatoire 40 % de dégâts en plus ou 40 PV à l'impact.", 'tier_id' => NULL, 'item1_id' => 9, 'item2_id' => 3, 'image' => 'HandOfJustice.png', 'enabled' => true]);
        // 9.19 Item::create(['name' => "Lame d'infini", 'description' => "Les dégâts des coups critiques sont augmentés de 200 %", 'tier_id' => 6, 'item1_id' => 9, 'item2_id' => 1, 'image' => 'InfinityEdge.png', 'enabled' => true]);
        // 9.19 Item::create(['name' => "Gantelet des arcanes", 'description' => "Vos capacités peuvent infliger des coups critiques.", 'tier_id' => NULL, 'item1_id' => 9, 'item2_id' => 5, 'image' => 'ArcaneGauntlet.png', 'enabled' => true]);
        // 9.19 Item::create(['name' => "Mercure", 'description' => "Empêche le prochain effet de contrôle de foule lancé sur le porteur.", 'tier_id' => NULL, 'item1_id' => 9, 'item2_id' => 2, 'image' => 'Quicksilver.png', 'enabled' => true]);
        // 9.19 Item::create(['name' => "Gantelet givrant", 'description' => "À chaque esquive, crée une zone extensible qui réduit la vitesse d'attaque de 30 %.", 'tier_id' => NULL, 'item1_id' => 9, 'item2_id' => 7, 'image' => 'IceborneGauntlet.png', 'enabled' => true]);
        // 9.19 Item::create(['name' => "Revers", 'description' => "Le porteur débute le combat avec un bouclier antisorts. Étourdit de manière prolongée l'ennemi qui brise le bouclier.", 'tier_id' => NULL, 'item1_id' => 9, 'item2_id' => 4, 'image' => 'Backhand.png', 'enabled' => true]);
        // 9.19 Item::create(['name' => "Arbalète à répétition", 'description' => "À la mort du porteur, l'Arbalète à répétition passe dans la main d'un nouvel allié qui gagne 20 % de chances de coup critique et 20 % de vitesse d'attaque.", 'tier_id' => NULL, 'item1_id' => 9, 'item2_id' => 6, 'image' => 'RepeatingCrossbow.png', 'enabled' => true]);
        // 9.19 Item::create(['name' => "Moufles", 'description' => "+ 10 % de chances de coup critique et + 10 % de chances d'esquive. Le porteur est aussi un Yordle.", 'tier_id' => NULL, 'item1_id' => 9, 'item2_id' => 8, 'image' => 'Mittens.png', 'enabled' => true]);
    }
}
