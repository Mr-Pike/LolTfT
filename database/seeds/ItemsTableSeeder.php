...
class ItemsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Item::create(['id' => 11, 'name' => "Cœur gelé", 'description' => "Les ennemis adjacents attaquent 20 % moins vite", 'tier_id' => 5, 'item1_id' => 3, 'item2_id' => 7, 'image' => 'FrozenHeart.png', 'enabled' => true]);
        Item::create(['id' => 12, 'name' => "Lame d'infini", 'description' => "Les dégâts des coups critiques sont augmentés de 150 %", 'tier_id' => 1, 'item1_id' => 9, 'item2_id' => 1, 'image' => 'InfinityEdge.png', 'enabled' => true]);
        Item::create(['id' => 13, 'name' => "Étincelle Ionique", 'description' => "Lorsqu'un ennemi envoie un sort, il subit 125 de dégâts bruts", 'tier_id' => 4, 'item1_id' => 2, 'item2_id' => 5, 'image' => 'IonicSpark.png', 'enabled' => true]);
        ...
        Item::create(['id' => 24, 'name' => "Tueur de géants", 'description' => "inflige des dégâts bruts équivalents à 5 % des PV max de la cible", 'tier_id' => 2, 'item1_id' => 1, 'item2_id' => 6, 'image' => 'GiantSlayer.png', 'enabled' => true]);
        ...
        Item::create(['id' => 27, 'name' => "Hydre titanesque", 'description' => "Les attaques infligent 10% des PV max de dégâts éparpillés", 'tier_id' => 5, 'item1_id' => 4, 'item2_id' => 6, 'image' => 'TitanicHydra.png', 'enabled' => true]);
        ...
        Item::create(['id' => 39, 'name' => "Pistolame Hextech", 'description' => "Soigne de 25% des dégâts infligés", 'tier_id' => 3, 'item1_id' => 1, 'item2_id' => 5, 'image' => 'HextechGunblade.png', 'enabled' => true]);
        ...
        Item::create(['id' => 46, 'name' => "Gants de voleur", 'description' => "Au début de la manche, vous gagnez deux objets temporaires", 'tier_id' => 1, 'item1_id' => 9, 'item2_id' => 9, 'image' => 'ThiefsGloves.png', 'enabled' => true]);
