...
class CreateChampionsMainView extends Migration
{
    ...
    public function up()
    {
        ...
        CONCAT('[', GROUP_CONCAT(DISTINCT(CONCAT('{\"combined_name\": \"', I0.name, '\", \"combined_image\": \"', I0.image, '\", \"base1_name\": \"', I1.name, '\", \"base1_image\": \"', I1.image, '\", \"base2_name\": \"', I2.name, '\", \"base2_image\": \"', I2.image,'\"}')) ORDER BY CI.order_number), ']') AS items
        FROM Champions C
